...
let samepermanentaddress = document.getElementById('samepermanentaddress');
    ...
    if (samepermanentaddress.checked == true) {
        ...
        let ResHouse_Block_LotNoValue = ResHouse_Block_LotNo.value;
        let ResStreetValue = ResStreet.value;
        let ResSubdivision_VillageValue = ResSubdivision_Village.value;
        let ResBarangayValue = ResBarangay.value;
        let ResCity_MunicipalityValue = ResCity_Municipality.value;
        let ResProvinceValue = ResProvince.value;
        let ResZipCodeValue = ResZipCode.value;
        
        PerHouse_Block_LotNo.value = ResHouse_Block_LotNoValue;
        PerStreet.value = ResStreetValue;
        PerSubdivision_Village.value = ResSubdivision_VillageValue;
        PerBarangay.value = ResBarangayValue;
        PerCity_Municipality.value = ResCity_MunicipalityValue;
        PerProvince.value = ResProvinceValue;
        PerZipCode.value = ResZipCodeValue;
        
    } else {
        
        PerHouse_Block_LotNo.value = "";
        PerStreet.value = "";
        PerSubdivision_Village.value = "";
        PerBarangay.value = "";
        PerCity_Municipality.value = "";
        PerProvince.value = "";
        PerZipCode.value = "";
    };
